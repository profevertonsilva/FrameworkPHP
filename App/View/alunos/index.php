                        ...
                        <div class="row stats-row">
                                ...
                                <div class="card card-transparent stats-card">
                                    <div class="card-body">
                                        <div class="stats-info">
                                            <h5 class="card-title"><?= $this->getView()->usuarios->__get('totaladministradores'); ?></h5>
                                            <p class="stats-text">Administradores Cadastrados <a href="/dashboard/administradores" class="btn btn-primary rounded-pill">Ver</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-12">
                                <div class="card card-transparent stats-card">
                                    <div class="card-body">
                                        <div class="stats-info">
                                            <h5 class="card-title"><?= $this->getView()->usuarios->__get('totalprofissionais'); ?></h5>
                                            <p class="stats-text">Profissionais Cadastrados <a href="/dashboard/profissionais" class="btn btn-primary rounded-pill">Ver</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-12">
                                <div class="card card-transparent stats-card">
                                    <div class="card-body">
                                        <div class="stats-info">
                                            <h5 class="card-title"><?= $this->getView()->usuarios->__get('totallojistas'); ?></h5>
                                            <p class="stats-text">Lojistas Cadastrados <a href="/dashboard/lojistas" class="btn btn-primary rounded-pill">Ver</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
